...
export default function HeroSection() {
  return (
    <motion.section
      ...
      className="relative mb-6 p-6 sm:p-8 rounded-card border border-border bg-surface bg-noise-subtle overflow-hidden"
    >
      <div className="max-w-4xl relative z-10">
        <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-btn text-xs font-medium bg-white border border-border text-text-secondary mb-3">
